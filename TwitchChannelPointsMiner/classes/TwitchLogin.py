...
class TwitchLogin(object):
    ...
    def login_flow(self):
        ...
        post_data = {
            ...
            "scopes": (
                "channel_read chat:read chat:edit user:write:chat "
                "user_blocks_edit user_blocks_read user_follows_edit user_read"
            )
        }
        # login-fix
        ...
        while True:
            ...
            if "user_code" in login_response_json:
                ...
                try:
                    from TwitchChannelPointsMiner.platform.auth_state import write_auth_state
                    ...
                    write_auth_state(
                        self.username,
                        {
                            ...
                            "user_code": user_code,
                            "verification_uri": login_response_json.get(
                                "verification_uri", "https://www.twitch.tv/activate"
                            ),
                            "expires_in": int(login_response_json.get("expires_in", 1800)),
                        },
                    )
                except Exception:
                    pass
